...
speedyapply_ai) output - the topmost row physically present in each category
section / table, independent of the --days filter used for that run - and
records it as the new marker.
...
speedyapply and speedyapply_ai are two distinct boards (2027-SWE-College-Jobs
